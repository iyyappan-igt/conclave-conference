...
const RoundtableSessions = ({ data }) => {
    const workshopsData = [
  {
    ...
    speakerImage:
      "/assets/SkyRocket/Dr. T. Senthil.png"
  },
  {
    id: 2,
    type: "workshop",
   ...
   speakerImage:
      "/assets/SkyRocket/Dr Sanjay Kulkarni.png"
  },
  {
    id: 3,
    type: "workshop",
    ...
    speakerImage:
       "/assets/SkyRocket/Mr Abdul Lathif.png"
  },
  {
    id: 4,
    type: "workshop",
        ...
        <section className={`${styles.container} container-fluid`}>
            <div className={`${styles.contentContainer} container`}>
                ...
                {workshopsData.map(workshop => (
                    <EventCard id={workshop?.id} type={workshop?.type}
                        title={workshop?.title}
                        speaker={workshop?.speaker}
                        overview={workshop?.overview}
                        startdate={workshop?.startdate}
                        enddate={workshop?.enddate}
                        non_member_amount={workshop?.non_member_amount}
                        amount={workshop?.amount}
                        status={workshop?.status}
                        designation={workshop?.designation}
